    ...
    <div className="h-full flex flex-col overflow-y-auto scrollbar-hide px-[13px] md:px-12 pt-8 md:pt-14 pb-8 md:pb-12">
      <div className="flex-grow flex flex-col items-center justify-center text-center max-w-2xl mx-auto w-full">
        ...
        <div className="space-y-2 md:space-y-4 mb-8 md:mb-10">
          ...
          <h1 className="text-[26px] md:text-5xl lg:text-6xl font-[900] tracking-tighter text-slate-900 leading-[1.1] whitespace-nowrap mx-auto">
          ...
          <p className="text-[12px] md:text-lg text-slate-500 max-w-xs md:max-w-lg mx-auto leading-relaxed font-medium px-4">
            Identify high-ROI automation gaps in your business architecture with our 2-minute diagnostic.
          </p>
        </div>

        {/* Feature Grid - Compacted */}
        <div className="grid grid-cols-3 gap-2.5 md:gap-3 mb-10 md:mb-12 w-full">
          {[
            ...
            <div key={i} className="p-3 md:p-5 bg-white border border-slate-100 rounded-[1.5rem] md:rounded-3xl flex flex-col items-center justify-center gap-1 md:gap-2 transition-all hover:border-slate-900 hover:shadow-xl hover:shadow-slate-900/5 duration-500 group cursor-default">
      ...
      <div className="mt-6 flex flex-col items-center opacity-30">
        <p className="text-[7px] md:text-[8px] font-black uppercase tracking-[0.4em] text-slate-500">
          SYDNEY • LONDON • TOKYO
        </p>
      </div>
    </div>
